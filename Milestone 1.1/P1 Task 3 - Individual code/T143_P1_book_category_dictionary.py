#Case 1 Function definitions;P1 - Task 3 - Individual function (Milestone 1)
#T143:
...
def book_category_dictionary(filename:str)->dict:
    ...
    file=open('google_books_dataset.csv', 'r').readlines()
    fix={}
    ...
    for j in range(len(cat)):
        for i in range(1,len(l5)):
            if cat[j]==l5[i]:
                new={l0[0]: l0[i],l1[0]: l1[i],l2[0]: l2[i],l3[0]: l3[i],l4[0]: l4[i],l6[0]: l6[i]}
