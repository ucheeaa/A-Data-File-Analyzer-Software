...
#To be used for Function 1: sort_books_title testing
#T143:
...
def sort_books_title(my_dictionary: dict) -> list[dict]:
    
    """
    Returns a list with the book data stored as a dictionary sorted in alphabetical
    order relative to the title, based on the "my_dictionary" dictionary argument.
